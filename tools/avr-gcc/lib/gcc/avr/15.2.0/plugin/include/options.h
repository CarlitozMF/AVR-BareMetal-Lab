...
#endif
#ifdef GENERATOR_FILE
extern int avropt_fuse_move2;
#else
  int x_avropt_fuse_move2;
#define avropt_fuse_move2 global_options.x_avropt_fuse_move2
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_optimization
{
  ...
  signed char x_avropt_fuse_move2;
...
enum opt_code
{
  ...
  OPT_Waddr_space_convert = 465,             /* -Waddr-space-convert */
  ...
  OPT_Wmisspelled_isr = 746,                 /* -Wmisspelled-isr */
  ...
  OPT_list = 2040,                           /* -list */
  OPT_mabsdata = 2041,                       /* -mabsdata */
  OPT_maccumulate_args = 2042,               /* -maccumulate-args */
  OPT_main = 2043,                           /* -main */
  OPT_main_ = 2044,                          /* -main= */
  OPT_mbranch_cost_ = 2045,                  /* -mbranch-cost= */
  OPT_mcall_main = 2046,                     /* -mcall-main */
  OPT_mcall_prologues = 2047,                /* -mcall-prologues */
  OPT_mcvt = 2048,                           /* -mcvt */
  OPT_mdeb = 2049,                           /* -mdeb */
  OPT_mdouble_ = 2050,                       /* -mdouble= */
  OPT_mflmap = 2051,                         /* -mflmap */
  OPT_mfract_convert_truncate = 2052,        /* -mfract-convert-truncate */
  /* OPT_mfuse_add = 2053, */                /* -mfuse-add */
  OPT_mfuse_add_ = 2054,                     /* -mfuse-add= */
  /* OPT_mfuse_move = 2055, */               /* -mfuse-move */
  OPT_mfuse_move2 = 2056,                    /* -mfuse-move2 */
  OPT_mfuse_move_ = 2057,                    /* -mfuse-move= */
  OPT_mgas_isr_prologues = 2058,             /* -mgas-isr-prologues */
  OPT_mint8 = 2059,                          /* -mint8 */
  OPT_mlog_ = 2060,                          /* -mlog= */
  OPT_mlong_double_ = 2061,                  /* -mlong-double= */
  OPT_mlra = 2062,                           /* -mlra */
  OPT_mmain_is_OS_task = 2063,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 2064,                          /* -mmcu= */
  OPT_mn_flash_ = 2065,                      /* -mn-flash= */
  OPT_mno_interrupts = 2066,                 /* -mno-interrupts */
  OPT_morder1 = 2067,                        /* -morder1 */
  OPT_morder2 = 2068,                        /* -morder2 */
  OPT_mpmem_wrap_around = 2069,              /* -mpmem-wrap-around */
  OPT_mpr118012 = 2070,                      /* -mpr118012 */
  OPT_mrelax = 2071,                         /* -mrelax */
  OPT_mrmw = 2072,                           /* -mrmw */
  OPT_mrodata_in_ram = 2073,                 /* -mrodata-in-ram */
  OPT_mshort_calls = 2074,                   /* -mshort-calls */
  OPT_mskip_bug = 2075,                      /* -mskip-bug */
  OPT_msp8 = 2076,                           /* -msp8 */
  OPT_msplit_bit_shift = 2077,               /* -msplit-bit-shift */
  OPT_msplit_ldst = 2078,                    /* -msplit-ldst */
  OPT_mstrict_X = 2079,                      /* -mstrict-X */
  OPT_mtiny_stack = 2080,                    /* -mtiny-stack */
  OPT_muse_nonzero_bits = 2081,              /* -muse-nonzero-bits */
  OPT_n = 2082,                              /* -n */
  OPT_name_sort = 2083,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2084,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2085,              /* -no-integrated-cpp */
  OPT_no_pie = 2086,                         /* -no-pie */
  OPT_nocpp = 2087,                          /* -nocpp */
  OPT_nodefaultlibs = 2088,                  /* -nodefaultlibs */
  OPT_nodevicelib = 2089,                    /* -nodevicelib */
  OPT_nodevicespecs = 2090,                  /* -nodevicespecs */
  OPT_nolibc = 2091,                         /* -nolibc */
  OPT_nomain = 2092,                         /* -nomain */
  OPT_nophoboslib = 2093,                    /* -nophoboslib */
  OPT_nostartfiles = 2094,                   /* -nostartfiles */
  OPT_nostdinc = 2095,                       /* -nostdinc */
  OPT_nostdinc__ = 2096,                     /* -nostdinc++ */
  OPT_nostdlib = 2097,                       /* -nostdlib */
  OPT_nostdlib__ = 2098,                     /* -nostdlib++ */
  OPT_o = 2099,                              /* -o */
  OPT_objects = 2100,                        /* -objects */
  OPT_p = 2101,                              /* -p */
  OPT_pass_exit_codes = 2102,                /* -pass-exit-codes */
  /* OPT_pedantic = 2103, */                 /* -pedantic */
  OPT_pedantic_errors = 2104,                /* -pedantic-errors */
  OPT_pg = 2105,                             /* -pg */
  OPT_pie = 2106,                            /* -pie */
  OPT_pipe = 2107,                           /* -pipe */
  OPT_preprocess = 2108,                     /* -preprocess */
  OPT_print_file_name_ = 2109,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2110,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2111,          /* -print-multi-directory */
  OPT_print_multi_lib = 2112,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2113,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2114,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2115,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2116,               /* -print-prog-name= */
  OPT_print_search_dirs = 2117,              /* -print-search-dirs */
  OPT_print_sysroot = 2118,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2119,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2120,                    /* -print-value */
  OPT_quiet = 2121,                          /* -quiet */
  OPT_r = 2122,                              /* -r */
  OPT_remap = 2123,                          /* -remap */
  OPT_reverse_sort = 2124,                   /* -reverse-sort */
  OPT_s = 2125,                              /* -s */
  OPT_save_temps = 2126,                     /* -save-temps */
  OPT_save_temps_ = 2127,                    /* -save-temps= */
  OPT_shared = 2128,                         /* -shared */
  OPT_shared_libgcc = 2129,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2130,               /* -shared-libphobos */
  OPT_size_sort = 2131,                      /* -size-sort */
  /* OPT_specs = 2132, */                    /* -specs */
  OPT_specs_ = 2133,                         /* -specs= */
  OPT_static = 2134,                         /* -static */
  OPT_static_libasan = 2135,                 /* -static-libasan */
  OPT_static_libgcc = 2136,                  /* -static-libgcc */
  OPT_static_libgcobol = 2137,               /* -static-libgcobol */
  OPT_static_libgfortran = 2138,             /* -static-libgfortran */
  OPT_static_libgm2 = 2139,                  /* -static-libgm2 */
  OPT_static_libgo = 2140,                   /* -static-libgo */
  OPT_static_libhwasan = 2141,               /* -static-libhwasan */
  OPT_static_liblsan = 2142,                 /* -static-liblsan */
  OPT_static_libmpx = 2143,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2144,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2145,               /* -static-libphobos */
  OPT_static_libquadmath = 2146,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2147,               /* -static-libstdc++ */
  OPT_static_libtsan = 2148,                 /* -static-libtsan */
  OPT_static_libubsan = 2149,                /* -static-libubsan */
  OPT_static_pie = 2150,                     /* -static-pie */
  /* OPT_std_c__03 = 2151, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2152, */                /* -std=c++0x */
  OPT_std_c__11 = 2153,                      /* -std=c++11 */
  OPT_std_c__14 = 2154,                      /* -std=c++14 */
  OPT_std_c__17 = 2155,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2156, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2157, */                /* -std=c++1z */
  OPT_std_c__20 = 2158,                      /* -std=c++20 */
  OPT_std_c__23 = 2159,                      /* -std=c++23 */
  OPT_std_c__26 = 2160,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2161, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2162, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2163, */                /* -std=c++2c */
  OPT_std_c__98 = 2164,                      /* -std=c++98 */
  OPT_std_c11 = 2165,                        /* -std=c11 */
  OPT_std_c17 = 2166,                        /* -std=c17 */
  /* OPT_std_c18 = 2167, */                  /* -std=c18 */
  /* OPT_std_c1x = 2168, */                  /* -std=c1x */
  OPT_std_c23 = 2169,                        /* -std=c23 */
  /* OPT_std_c2x = 2170, */                  /* -std=c2x */
  OPT_std_c2y = 2171,                        /* -std=c2y */
  /* OPT_std_c89 = 2172, */                  /* -std=c89 */
  OPT_std_c90 = 2173,                        /* -std=c90 */
  OPT_std_c99 = 2174,                        /* -std=c99 */
  /* OPT_std_c9x = 2175, */                  /* -std=c9x */
  OPT_std_f2003 = 2176,                      /* -std=f2003 */
  OPT_std_f2008 = 2177,                      /* -std=f2008 */
  OPT_std_f2008ts = 2178,                    /* -std=f2008ts */
  OPT_std_f2018 = 2179,                      /* -std=f2018 */
  OPT_std_f2023 = 2180,                      /* -std=f2023 */
  OPT_std_f202y = 2181,                      /* -std=f202y */
  OPT_std_f95 = 2182,                        /* -std=f95 */
  OPT_std_gnu = 2183,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2184, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2185, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2186,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2187,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2188,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2189, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2190, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2191,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2192,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2193,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2194, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2195, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2196, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2197,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2198,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2199,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2200, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2201, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2202,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2203, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2204,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2205, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2206,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2207,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2208, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2209, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2210,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2211, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2212, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2213, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2214, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2215, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2216, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2217,                     /* -std=legacy */
  OPT_stdlib_ = 2218,                        /* -stdlib= */
  OPT_symbol_ = 2219,                        /* -symbol= */
  OPT_symbolic = 2220,                       /* -symbolic */
  OPT_t = 2221,                              /* -t */
  OPT_time = 2222,                           /* -time */
  OPT_time_ = 2223,                          /* -time= */
  OPT_traditional = 2224,                    /* -traditional */
  OPT_traditional_cpp = 2225,                /* -traditional-cpp */
  OPT_tree_stats = 2226,                     /* -tree-stats */
  OPT_trigraphs = 2227,                      /* -trigraphs */
  OPT_truncate = 2228,                       /* -truncate */
